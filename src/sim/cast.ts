...
export const CUSTOMERS: Record<CustomerId, CustomerSeed> = {
  shen: { id: "shen", name: "沈薇", role: "熟客博主", art: "/assets/chibi/shen.png", portrait: "/assets/aurora/customer-shen-consultation.png", opening: "先说好，我不缺粉底。又是品牌话术，我就去对面。", need: "镜头近看不浮粉", bestProduct: "soft", sale: 2860, wrongSale: 3480, patience: 4, lostLine: "陆遥带沈薇去了维珞", rival: true, wait: "tester", cluePool: ["她把镜头凑到鼻翼上看粉感。", "包里已经有一支厚粉底。", "她在看对面的持妆赠品袋。"], fits: { soft: "good", glow: "push", repair: "poor" } },
  mei: { id: "mei", name: "梅女士", role: "下班客", art: "/assets/chibi/mei.png", portrait: "/assets/aurora/customer-mei-consultation.png", opening: "我明早要见客户。别给我推荐一整套。", need: "快速改善干燥疲态", bestProduct: "repair", sale: 1680, wrongSale: 2560, patience: 6, lostLine: "梅女士看了看表，赶去地铁", rival: false, wait: "tester_side", cluePool: ["妆面干，嘴角起皮。", "她看了两次手表。", "她拿起了最贵的套组盒子。"], fits: { soft: "poor", glow: "push", repair: "good" } },
  xiaoyu: { id: "xiaoyu", name: "小雨", role: "预算有限", art: "/assets/chibi/xiaoyu.png", portrait: "/assets/aurora/customer-xiaoyu-consultation.png", opening: "我只有一千块。别闷痘。", need: "不刺激痘肌，预算内改善气色", bestProduct: "soft", sale: 980, wrongSale: 1680, patience: 6, lostLine: "小雨被中庭小样台叫走", rival: false, wait: "tester_side", cluePool: ["下巴有新痘。", "她把零钱数了两遍。", "她问套组能不能分期。"], fits: { soft: "good", glow: "poor", repair: "poor" } },
  zhou: { id: "zhou", name: "周姐", role: "对比维珞", art: "/assets/chibi/zhou.png", portrait: "/assets/aurora/customer-zhou-consultation.png", opening: "对面说你们持妆会暗沉。给我一个站得住的理由。", need: "拍照不暗沉，但不能像换了一层皮", bestProduct: "glow", sale: 1280, wrongSale: 620, patience: 5, lostLine: "陆遥把周姐接到了维珞", rival: true, wait: "tester", cluePool: ["她捏着维珞的试色卡。", "她停在绮光持妆柜的立牌前。", "她摸了摸脸，像是嫌厚。"], fits: { soft: "poor", glow: "good", repair: "poor" } },
  zhao: { id: "zhao", name: "赵女士", role: "给女儿买", art: "/assets/chibi/zhao.png", portrait: "/assets/aurora/customer-zhao-consultation.png", opening: "东西是买给我女儿的。你别看我的脸。", need: "敏感肌、低风险礼物", bestProduct: "repair", sale: 1680, wrongSale: 2860, patience: 6, lostLine: "赵女士说再问问女儿", rival: false, wait: "tester", cluePool: ["她不照镜子，只看盒子。", "她把女儿过敏史念了一遍。", "她问哪套包装最好看。"], fits: { soft: "poor", glow: "push", repair: "good" } },
  duan: { id: "duan", name: "段小姐", role: "说只看看", art: "/assets/chibi/duan.png", portrait: "/assets/aurora/customer-duan-consultation.png", opening: "我就是看看。你们别围上来。", need: "给易闷痘的室友选对礼物", bestProduct: "soft", sale: 980, wrongSale: 1680, patience: 5, lostLine: "段小姐去中庭领了别的小样", rival: false, wait: "aisle", cluePool: ["她站在过道，一靠近就退半步。", "手机备忘录写着室友闷痘。", "她看了一眼中庭免费小样台。"], fits: { soft: "good", glow: "poor", repair: "poor" } },
  anjie: { id: "anjie", name: "安姐", role: "婚前试妆", art: "/assets/chibi/anjie.png", portrait: "/assets/aurora/customer-anjie-consultation.png", opening: "婚礼还有一周。我要一套绝对不出错的。", need: "先稳定泛红，再做轻薄婚礼妆", bestProduct: "repair", sale: 6800, wrongSale: 9200, patience: 7, lostLine: "安姐让苏蔓接手", rival: false, wait: "tester", cluePool: ["两颊有固定泛红。", "苏蔓站在她侧后方没走远。", "她把最贵的全套往自己面前推。"], fits: { soft: "poor", glow: "push", repair: "good" } },
  returning: { id: "returning", name: "沈薇", role: "带团队回来", art: "/assets/chibi/shen.png", portrait: "/assets/aurora/customer-shen-consultation.png", opening: "昨天那次直播间都在问。你得保证不是昙花一现。", need: "稳定复现轻薄效果", bestProduct: "soft", sale: 4200, wrongSale: 1680, patience: 6, lostLine: "沈薇说团队先去维珞", rival: true, wait: "tester", cluePool: ["助理举着手机要拍同款。", "她翻出上次的轻薄小票。", "她问持妆能不能撑整场直播。"], fits: { soft: "good", glow: "push", repair: "poor" } },
  zhou2: { id: "zhou2", name: "周姐", role: "替同事看", art: "/assets/chibi/zhou.png", portrait: "/assets/aurora/customer-zhou-consultation.png", opening: "同事问有没有修护。今天顺便看。", need: "给同事带低刺激修护", bestProduct: "repair", sale: 1680, wrongSale: 1280, patience: 5, lostLine: "周姐说同事先去对面问", rival: false, wait: "tester_side", cluePool: ["她念同事的敏感词。", "袋子里已经有一支绮光持妆。", "她问有没有更贵的套组。"], fits: { soft: "poor", glow: "poor", repair: "good" } },
};
...
export const STAFF: StaffSeed[] = [
  { id: "xuyuan", name: "许愿", role: "试用期柜姐", art: "/assets/chibi/xuyuan.png", portrait: "/assets/aurora/xuyuan.png", home: "xuyuan", lines: ["我先看她真正要什么。", "陆遥已经靠过来了。"] },
  { id: "luyao", name: "陆遥", role: "竞品销冠", art: "/assets/chibi/luyao.png", portrait: "/assets/aurora/luyao.png", home: "luyao", lines: ["这单我也可以做。", "她之前用我们家持妆。"] },
  { id: "roman", name: "罗曼", role: "柜长", art: "/assets/chibi/roman.png", portrait: "/assets/aurora/roman.png", home: "roman", lines: ["客单，别只顾着聊天。", "今日排名已更新。"] },
  { id: "suman", name: "苏蔓", role: "资深柜姐", art: "/assets/chibi/suman.png", portrait: "/assets/aurora/suman.png", home: "suman", lines: ["先看她的皮肤，再开口。", "闭店后来找我。"] },
  { id: "tangke", name: "唐可", role: "同期新人", art: "/assets/chibi/tangke.png", portrait: "/assets/aurora/tangke.png", home: "tangke", lines: ["这单本来可以留下。", "别把人往外推。"] },
  { id: "fangmin", name: "方敏", role: "合规", art: "/assets/chibi/fangmin.png", portrait: "/assets/aurora/fangmin.png", home: "backroom", lines: ["缺口要对得上人。", "我要一个能写进档案的说法。"] },
];
